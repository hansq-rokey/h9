...
import com.weixinpay.utils.RequestHandler;
...
public class WeixinPayUtils {
	...
	private static String appid = "wxa6aa5833e4953106";
	private static String appsecret = "41bbcef4e5aa84c189f33af4696bb3c1";
	private static String partner = "1269303801";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "wwwibaixiongcomwwwibaixiongcombx";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.ibaixiong.com/pay/notify/wx/pc.html";																	 // Key
	...
	public static void main(String[] args) {
		...
		String str1 =  getPackage(tpWxPay);
		...
		String str2 = getCodeurl(tpWxPay1);
