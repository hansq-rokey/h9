...
<html>
	            ...
	            <div class="pay-main">
	                ...
	                <div class="pay-info right">
	                    <div class="pay-infor-box">
	                        <p class="ordernum">定金编号：${ orderNumber }</p>
	                        <div class="line"></div>
 ...
 <script>
	...
	function check(){
		$.ajax({
	 		   url: "/u/weixin/deposit/checkOrderPay.html?orderNumber="+orderNumber,
	 		   type: "POST",
	 		   dataType:"json",
	 		   cache:false,
	 		   success: function(obj){
	 			  if ( !checkCode( obj ) ) {
	 				...
	 				window.location.href= baseUrl+"/u/weixin/deposit/payEnd.html?payType=2&orderNumber="+orderNumber;
	 			  }
	 		   }
	 	});
		++count;
