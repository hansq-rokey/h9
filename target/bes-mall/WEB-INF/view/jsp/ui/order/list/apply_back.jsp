    ...
    <div class="content">
        ...
        <div class="clearfix">
            ...
            <div class="content-right">
                ...
                <div class="row">
                    <p ${isAfter? '':'style="color: red;"' }>请选择所需服务，信息提交后我们会尽快安排客服人员与您联系！产品在七天之内可申请退货 </p>
                </div>
                <div class="row">
                    <p>请选择维修产品<span class="light">保修期内质量问题免费维修，保修期外有偿维修</span></p>
                </div>
                ...
                <div class="row">
                    ...
                    <c:forEach items="${orderItems }" varStatus="statusItem" var="orderItem">
                       		<tr>
                                <td>
                                    <div class="">
                                        <input type="checkbox" checked="checked" isCheck="true"  name="items[${statusItem.index}].id" class="checked" value="${orderItem.id }">
                                ...
                                <td class="tc" width="110">${isAfter?'可退货':'不可退货' }</td>
                            </tr>
                       	</c:forEach>
                    </table>
                </div>
               ...
               <div class="row">
                 ...
                 <div class="row">
                        <p class="servicetext">收货地址<span class="light">维修后的商品将送到该地址</span></p>
