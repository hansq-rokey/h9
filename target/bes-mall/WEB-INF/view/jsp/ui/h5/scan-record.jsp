...
<body>
<!--多次扫描-->
	<c:if test="${fn:length(listScanRecod)!=1}">
	<div class="mob_box product_false">
		<div class="mob_top mob_bc1 mob_of">
			...
			<p class="mob_tc1 mob_txterr">如果第一次不是您扫描,<br/>请拨打官方电话400-175-0088.<a href="index.html" style="display:none">查询详情 >> </a></p>
		...
		<div class="mob_footer">
			<ul class="mob_arguments">
				<li>
					...
					<p class="mob_argtxt">
						<span class="mob_fz14 mob_db mob_tc1 font-w">${productName }</span>
				...
				<li>
					...
					<p class="mob_argtxt">
						<span class="mob_fz14 mob_db mob_tc1 font-w">${productFormat }</span>
				...
				<li>
					...
					<p class="mob_argtxt">
						<span class="mob_fz14 mob_db mob_tc1 font-w"><fmt:formatDate value="${ productMfgDate }" pattern="YYYY-MM-dd" /></span>
	...
	<div class="option_box">
		<a href="http://html.ibaixiong.com/html/app_download_scan.html" class="option_list font-w "><i class="option option_down"></i><span>熊爸爸<br>app下载</span></a>	
		<a href="###" class="option_list option_link font-w"><i class="option option_link"></i><span>手机连接<br>视频教程</span></a>	
	</div>
</body>
</html>